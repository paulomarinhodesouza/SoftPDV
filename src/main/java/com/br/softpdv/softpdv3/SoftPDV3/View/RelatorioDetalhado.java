...
public class RelatorioDetalhado extends javax.swing.JFrame {
    ...
    /**
     * Creates new form RelatorioDetalhado
     */
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Relatório Detalhado");
    ...
    private void relatorioDetalhado(){
        ...
        if(!listaVendas.listar().isEmpty()){
            for(Vendas v : listaVendas.listar()){
                JTRelatorio.append("---------------------------\n");
                JTRelatorio.append("Venda " + listaVendas.listar().indexOf(v)+ ":\n" + v.getProdutos());
                JTRelatorio.append("Valor total: " + v.getVlTotal()+"\n");
            }
            JTRelatorio.append("---------------------------\n");
